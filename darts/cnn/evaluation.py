...
parser.add_argument('--data', type=str, default='/data/Fanliang/data', help='location of the data corpus')
...
parser.add_argument('--subnet',type=str,help="subnet")
parser.add_argument('--net_id',type=int,help="net_id")
